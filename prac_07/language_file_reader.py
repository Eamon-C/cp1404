...
def main():
    ...
    for line in in_file:
        ...
        # Pointer is stored as a string (Yes/No)
        pointer_reflection = parts[4] == "Yes"
        # Construct a ProgrammingLanguage object using the elements
        # year should be an int
        language = ProgrammingLanguage(parts[0], parts[1], reflection, int(parts[3]), pointer_reflection)
